...
営業事務時代、Excel VBAで在庫管理システムを構築し、通販商品全体で前年比120%の利益創出に貢献。旅行代理店では、Google Analyticsでデータ分析を行い、独自選定ツアーのメルマガで前週比1.3倍の反応率を達成し、上司から高評価をいただきました。この「データ分析→施策実行→結果確認→チームへの貢献」サイクルが、私の理想の働き方の原点です。

産後は子育てをしながら、ECサイトのマーケティング補助として、データ分析に触れ続けました。作業時間を75%削減する業務効率化を実現し、「もっとデータに深く関わりたい」と考え、データエンジニアに転身。

現在、データエンジニアとして1年11ヶ月、大手企業向けのデータ基盤構築・運用に従事。アパレル4ブランドのマーケティングタグ管理基盤の統合移行（2,724項目のテスト実施、タグ発火率99.8%達成）、BIデータマート構築（分析リードタイム96%削減）など、エンドツーエンドのデータエンジニアリング業務を提供。
...
**営業事務時代（2011-2013年）**
- Excel VBAで在庫管理システムを構築し、通販商品全体で前年比120%の利益創出に貢献
- 営業チームがスムーズに業務を進められる環境を実現
- 「データで需要と供給のバランスを取ることで、売上に貢献できる」ことを実感

**旅行代理店時代（2014-2019年）** - 理想の働き方の原点
- Google Analyticsでデータ分析を行い、独自選定ツアーのメルマガで前週比1.3倍の反応率を複数回達成
- 上司から「佐藤さんが作ったメルマガの反応良いよー！」と感謝された経験が、私にとって最も嬉しい瞬間でした
- この「データ分析→施策実行→結果確認→チームへの貢献」サイクルが、私の理想の働き方の原点です
- SQL・Pythonでデータを抽出・分析し、マーケティング施策に活かす面白さを知る

**産後・業務委託時代（2022-2023年）**
- 子育てをしながら、ECサイトのマーケティング補助としてデータ分析に触れ続けました
- 作業時間を75%削減する業務効率化を実現
- 「もっとデータに深く関わりたい」という想いが明確に

**データエンジニア時代（2024年1月～現在）**
- データエンジニアとして1年11ヶ月、大手企業向けのデータ基盤構築・運用に従事
- アパレル4ブランドのマーケティングタグ管理基盤の統合移行（タグ発火率99.8%達成）
- BIデータマート構築（分析リードタイム96%削減）など、技術的なスキルを習得

### 転職を決意した理由

データエンジニアとして技術的には成長していますが、3つの課題を感じています：

1. **全体像が見えない**：Why（なぜ）、Who（誰）、What（何）が分からないと、最適な提案ができない
2. **貢献実感がない**：データを整備しても、それがどう分析され、どんな施策に繋がり、どんな成果が出ているのかが見えない
3. **感謝される機会がない**：旅行代理店時代の「佐藤さんのおかげで反応良いよー！」という言葉が、私にとって最も嬉しい瞬間でした
